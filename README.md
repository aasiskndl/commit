...
Some of the big companies like OpenAI, Tesla are able to make a humanoid robot that can solve tasks, reason, think and perform like a human. They have greater amount of resources to utilize but if an individual plans to make a humanoid robot then it might be diffucult for him/her because we need to feed alot of data into a neural network which also requires alot of training process
